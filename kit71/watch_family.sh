...
while true; do
  for f in kit71/bench/family3_sym*_n*.txt kit71/bench/family3A_sym*_n*.txt kit71/bench/f47A_sym*_n*.txt kit71/bench/mixed_*_sym*_n*.txt kit71/bench/twoloop_n*_all_linux.txt; do
    [ -f "$f" ] || continue
