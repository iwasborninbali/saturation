...
with open(out, "w") as f:
    f.write("# ЗАДАЧА: a280537 n=7 M=19\n")
    f.write("# Объявление обязательно: в имени case_00007 НИЧЕГО не говорит, к какой задаче оно\n")
    f.write("#   относится, а куски задачи о трёх точках на прямой называются так же. Молчание\n")
    f.write("#   источника о своей задаче — не согласие; читающий обязан отвергать необъявленное.\n")
