...
\date{22 August 2026 --- version 1.3}
...
\end{tabular}
\end{center}
($n=5,6,7,8,10,15,\dots$ for the first row; $n=5,10,15,20,25,30$ for the others.)  There is no
plateau at any ratio.  The multiplier is not bounded: the heuristic understates the count by a
factor growing at least exponentially in $n$, faster at larger $r$.
...
$n/\ln n$ are also rejected, the best by a factor of eighty-four.  The honest per-point error is
$0.26\%$, measured from eight fully independent seeds at $n=30$, so the rejection is not an
artefact of optimistic error bars; it is stronger than the nominal ones suggested.

The rejection is confined to small $n$.  Taken on tails, three-parameter forms are admissible
from $n\ge15$ onward: $\chi^2=4.6/3$, $3.0/2$, $0.1/1$ for $c+an+bn\ln n$ at $n\ge15,20,25$.
The asymptotic regime appears to begin near $n=15$, and below it we were fitting asymptotic forms
to pre-asymptotic data.

On that tail the fit is stable and emphatic: $b=-0.0891\pm0.0010$, $-0.0871$, $-0.0814$ across
three nested tails --- eighty-six standard deviations from zero --- while the purely linear
$c+an$ is rejected at $\chi^2=2150/3$.  Read alone this says $E=\Theta(n\ln n)$ and the constant
...
\midrule
$c+an+b\,n\ln n$ & $3.00$ & constant moves\\
$c+an+d\sqrt n$ & $0.18$ & constant intact\\
$c+an+e\,n/\ln n$ & $1.76$ & constant intact\\
$c+an+f\ln n$ & $0.92$ & constant intact\\
\bottomrule
\end{tabular}
\end{center}
All four are admissible; three imply the opposite conclusion and fit better.  The eighty-six
