...
$k\to\infty$ the rencontres numbers converge to the Poisson law $e^{-1}/j!$ (in $\ell^1$, with error $\le2^{k+1}/(k+1)!$), and $C_k\to C_\infty=2.80488\ldots$;
since the integrand of \eqref{eq:Ck} is bounded by $12$, $|C_k-C_\infty|\le12\cdot2^{k+1}/(k+1)!$, so $C_k<2.81$ for every odd $k\ge7$.
