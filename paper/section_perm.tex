...
\begin{align}
 ...
 L&=\sum_\sigma\sum_c\Bigl([n_0\ge4]+[k'+n_0\ge4]+[k'+n_1\ge4]+[n_1\ge4]\Bigr),\label{eq:L}\\
...
\[
 \alpha(x^k,B)\ \le\ \bigl(C_k+\varepsilon_k+o(1)\bigr)\,p,\qquad 0\le\varepsilon_k\le\frac2{(k-1)!}+\frac4{k!},\quad \varepsilon_3=0,
\]
as $p\to\infty$; numerically $C_5+\varepsilon_5\le2.913$ and $C_7+\varepsilon_7\le2.808$.  In particular $\alpha(x^k,B)\le(1.46+o(1))\cdot2p<\tfrac32\cdot2p$:
...
with $j=k$ roots have density $P_k=1/k!$ per slope and contribute at most $4/k!\cdot p$ in total (four lines each) — this is the second part of
