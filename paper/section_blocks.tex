...
$401\le p\le1103$, i.e.
\[
 \alpha(\Pset_{-1})\ \le\ (3.4413\ldots+o(1))\,(p-1)\qquad\text{(numerically; the constant is a finite computation plus the local law)} .
\]
Truncating to runs of length $\le L_0$ gives proved constants once the corresponding densities are computed: $3.595$ for $L_0=5$,
$3.480$ for $L_0=7$, $3.452$ for $L_0=10$.  The bound~\eqref{eq:blocks} is \emph{below} the value of the linear relaxation with all these
