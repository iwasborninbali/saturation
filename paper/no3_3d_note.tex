...
\date{23 August 2026 --- version 1.3\\ \small\texttt{doi:10.5281/zenodo.22019279}}
...
all --- a bar is harmless under exhaustion, since it prunes only branches unable to exceed it.  An external
recount reports exactly $14$ optima of size $28$ (stabiliser orders $8$, $8$, $24$); our own sharded recount was
still running when this version was frozen, so that number is quoted as the reviewer's, not yet as ours.
