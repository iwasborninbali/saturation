...
\date{20 August 2026 --- version 1.1 (draft)\\ \small\texttt{doi:10.5281/zenodo.22019279}}
...
the rest.  What is counter-intuitive is that a \emph{larger} group gives a \emph{better} result: at $n=8$ the
groups of order $2$, $3$, $4$ and $6$ yield $82$, $88$, $88$ and $93$ points respectively.  The narrowing is
not a handicap but a purchase --- with $|G|=6$ there are six times fewer variables, and the solver reaches
configurations it never gets near in the full space within the same budget.  (An earlier draft of this note quoted
