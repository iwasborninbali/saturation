...
$n=6$: $12,10,10,10,10,12$ (total $64$) & feasible\\\bottomrule
\end{tabular}\end{center}
...
analogous profile realisable, so the obstruction is specific to $n=5$ and not to the idea of maximal outer layers.
