...
the substitution $t\mapsto-t$ carries the roots of $at^3+t=c$ to those of $at^3-t=-c$, so $c$ makes the former
cubic three-rooted iff $-c$ makes the latter three-rooted; hence the analogous count for $at^3+t=c$ is the same $N_3$.
...
with a Bombieri--Perel'muter estimate along a genus-$1$ Kummer twist of it.
