...
\end{lemma}
\begin{proof}
\emph{(1) The fibre products.}  The six discriminants are quadratics in $u$ with root sets $\{\pm(2/\alpha_m)\sqrt{\sigma/(3a)}\}$.  For fixed $\sigma$ the
...
\[
 ...
 e\Bigl(\tfrac1p\bigl(h_uu+h_vv(u)+\textstyle\sum_mh_m\alpha_mu+\sum_{s\in S}(h_st_s+h'_s(-\alpha_{m(s)}u-t_s))\bigr)\Bigr),
