...
half-turn (exactly three inequivalent ones in the two-loop family); for $n=37$ (two) and $n=39$ (one), the first located configurations of that
...
39 & 4047 (171) & $\ge1$ & $\ge0$ & C4 base: 300 non-central sub-classes swept (1 configuration), central in progress; V2 base: 3277 non-central swept (none), central complete (none)\\
