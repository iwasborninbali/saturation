...
half-turn (exactly three inequivalent ones in the two-loop family); for $n=37$ (two) and $n=39$ (three), the first located configurations of that
...
family; both database cells were empty), two for $n=37$ and three for $n=39$ ($3$-cycle family; the first located
...
39 & 4047 (171) & $\ge3$ & $\ge0$ & C4 base: 300 non-central sub-classes swept (1 configuration) and 108 central swept (2 configurations, defects through the central class), rest in progress; V2 base: 3277 non-central swept (none), central complete (none)\\
...
was not empty.  All nine configurations were checked to be pairwise inequivalent (canonical forms under $\Dfour$).  The
second and third $n=39$ configurations have their defects through the central class --- they were found only after the
correction of the generator described above.
