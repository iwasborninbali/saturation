...
half-turn (exactly three inequivalent ones in the two-loop family); for $n=37$ (two) and $n=39$ (two), the first located configurations of that
...
family; both database cells were empty), two for $n=37$ and two for $n=39$ ($3$-cycle family; the first located
...
database, whose rot2 column is complete for $n\le31$ --- none at $n=15,\dots,25$, $33$ and $37$, and a new one at $n=39$; the corrected counts are
...
39 & 4047 (171) & $\ge2$ & $\ge0$ & C4 base: 300 non-central sub-classes swept (1 configuration) and 75 central swept (1 configuration, defect through the central class), rest in progress; V2 base: 3277 non-central swept (none), central complete (none)\\
...
was not empty.  All eight configurations were checked to be pairwise inequivalent (canonical forms under $\Dfour$).  The
second $n=39$ configuration has its defect through the central class --- it was found only after the correction of the
